...
import { Zap, ArrowLeft, ExternalLink, Edit3 } from 'lucide-react'
...
export default function GamesPage() {
  ...
  const products = [
    ...
    {
      name: 'Controle Wireless Xbox',
      price: 'R$ 299,99',
      originalPrice: 'R$ 399,99',
      discount: '25% OFF',
      image: 'https://images.unsplash.com/photo-1592840062661-eb5ad9028c3e?w=300&h=300&fit=crop'
    },
    {
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">
                    Seu Link de Afiliado para Games
                  </label>
                  <input
                    type="url"
                    value={affiliateLink}
              ...
              <div className="flex items-center justify-between">
                ...
                {affiliateLink && (
                  <button
                    ...
                    className="flex items-center space-x-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-6 py-3 rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all transform hover:scale-105"
                  >
            ...
            {products.map((product, index) => (
              <div key={index} className="bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <button
                    onClick={handleRedirect}
                    className="w-full bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-bold py-3 px-6 rounded-xl hover:from-indigo-600 hover:to-purple-700 transition-all duration-300 transform hover:scale-105"
                  >
                    Ver Oferta
                  </button>
                </div>
      ...
      <section className="relative z-10 py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl max-w-4xl mx-auto text-center">
            ...
            <h3 className="text-3xl font-bold text-gray-800 mb-4">Games</h3>
            <p className="text-gray-600 text-lg leading-relaxed">
              Mergulhe no mundo dos games com as melhores ofertas em consoles, jogos, 
              acessórios gamer, periféricos e setup completo. Desde PlayStation e Xbox 
              até PC Gamer, encontre tudo com preços imperdíveis.
            </p>
          </div>
        </div>
      </section>
