...
import { Home, ArrowLeft, ExternalLink, Edit3 } from 'lucide-react'
...
export default function CasaJardimPage() {
  ...
  const products = [
    {
      name: 'Conjunto de Sofá 3 Lugares',
      price: 'R$ 1.299,99',
    ...
    },
    {
      ...
      discount: '31% OFF',
      image: 'https://images.unsplash.com/photo-1449247709967-d4461a6a6103?w=300&h=300&fit=crop'
    },
    {
      name: 'Kit Ferramentas Jardim',
      price: 'R$ 149,99',
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-gray-800">Casa & Jardim</h1>
            </div>
          </div>
        </div>
      </header>
              ...
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-700 font-medium mb-2">
                    Seu Link de Afiliado para Casa & Jardim
                  </label>
                  <input
                    type="url"
                    value={affiliateLink}
              ...
              <div className="flex items-center justify-between">
                ...
                {affiliateLink && (
                  <button
                    ...
                    className="flex items-center space-x-2 bg-gradient-to-r from-green-500 to-blue-600 text-white px-6 py-3 rounded-xl hover:from-green-600 hover:to-blue-700 transition-all transform hover:scale-105"
                  >
      ...
      <section className="relative z-10 py-12">
        <div className="container mx-auto px-4">
          <h3 className="text-3xl font-bold text-center mb-12 text-white">
            Ofertas Imperdíveis para Casa & Jardim
          </h3>
            ...
            {products.map((product, index) => (
              <div key={index} className="bg-white/95 backdrop-blur-sm rounded-2xl overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 transform hover:scale-105">
                ...
                <div className="p-6">
                  ...
                  <button
                    onClick={handleRedirect}
                    className="w-full bg-gradient-to-r from-green-500 to-blue-600 text-white font-bold py-3 px-6 rounded-xl hover:from-green-600 hover:to-blue-700 transition-all duration-300 transform hover:scale-105"
                  >
                    Ver Oferta
                  </button>
                </div>
      ...
      <section className="relative z-10 py-12">
        <div className="container mx-auto px-4">
          <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 shadow-2xl max-w-4xl mx-auto text-center">
            <Home className="h-16 w-16 text-green-600 mx-auto mb-6" />
            <h3 className="text-3xl font-bold text-gray-800 mb-4">Casa & Jardim</h3>
            <p className="text-gray-600 text-lg leading-relaxed">
              Transforme sua casa e jardim com as melhores ofertas em móveis, decoração, 
              eletrodomésticos, ferramentas de jardim e muito mais. Produtos de qualidade 
              com preços imperdíveis para deixar seu lar ainda mais especial.
            </p>
          </div>
        </div>
      </section>
